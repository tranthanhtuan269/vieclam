        ...
        <header>
            <div class="container">
                <div class="row clearfix">
                    <div class="logo clearfix"><a href=""><img src="{{ url('/') }}/images/{{ $company->logo }}" id="logo" alt=""><p>{{ $company->name }}</p></a></div>
            ...
            <div class="row ads clearfix">
            	<?php 
            		if(strlen($company->images) > 0){
            			$imagesString=rtrim($company->images,";");
            ...
            <div class="contents-job row">
                <div class="col-md-4 info-company col-xs-12">
                    ...
                    <div class="info">
                        ...
                        @if(strlen($company->sologan) > 0) <p class="time-new-roman"><i></i>{{ $company->sologan }}</p> @endif
                ...
                <div class="col-md-8  col-xs-12">
                    <div class="info-job">
                        ...
                        <p class="time-new-roman"><i></i>@if( $job->gender == 0 ) Nam @else Nữ @endif</p>
