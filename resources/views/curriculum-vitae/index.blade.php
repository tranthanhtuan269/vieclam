            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/admin/curriculum-vitae/create') }}" class="btn btn-success btn-sm" title="Add New CurriculumVitae">
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($curriculumvitae as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/curriculum-vitae/' . $item->id) }}" title="View CurriculumVitae"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/curriculum-vitae/' . $item->id . '/edit') }}" title="Edit CurriculumVitae"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
