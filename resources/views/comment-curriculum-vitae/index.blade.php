            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/user/comment-curriculum-vitae', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>User</th><th>Curriculumvitae</th><th>Description</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($commentcurriculumvitae as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                            ...
                            <div class="pagination-wrapper"> {!! $commentcurriculumvitae->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
