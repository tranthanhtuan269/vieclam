...
<div class="container">
	<div class="main-menu row">
		<div class="slide"><img src="{{ url('/') }}/img/{{ $company->banner }}" width="100%" height="auto" alt=""><img class="logo" src="{{ url('/') }}/img/{{ $company->logo }}" alt=""></div>
		<p class="menu">
			<a href="#">Thông Tin</a>
	...
	<div class="related-work row">
		...
		<div class="wrapper" id="wrapper">
			...
			<div id="contents">
			@foreach($jobs_suggest as $job_suggest)
				<div class="item-work">
					<div>
					<p class="work-img work-img-border"><img src="{{ url('/') }}/img/nhatuyendung.png" alt=""></p>
					<p class="location"><i></i>{{ $job_suggest->district }}</p>
					<p class="salary"><i></i>{{ $job_suggest->salary }}</p>
					<span class="work-view"><a href="{{ url('/') }}/job/{{$job->id}}">Xem thêm &rsaquo;</a></span>
					</div>
				</div>
			@endforeach
			</div>
